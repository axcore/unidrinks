...
function unilib.pkg.ingredient_grain_malt_crystallised.init()

    return {
        description = "Crystallised malt grain",
        depends = "misc_tray_brewer",
    }

end

function unilib.pkg.ingredient_grain_malt_crystallised.exec()

    unilib.register_craftitem(
        -- From beer_test:malt_grain_crystalised_malt
    ...
    unilib.register_craft({
        -- From beer_test:malt_grain_crystalised_malt
        type = "shapeless",
        output = "unilib:ingredient_grain_malt_crystallised",
        recipe = {"unilib:misc_tray_brewer_malt_crystallised"},
        replacements = {
            {"unilib:misc_tray_brewer_malt_crystallised", "unilib:misc_tray_brewer_empty"},
        },
    })
